            ...
            {category.menuItems.length > 0 ? (
              ...
              <div className="flex items-center justify-center p-8 text-center">
                <div>
                  ...
                  <h3 className="mt-4 text-lg font-medium">В этом разделе нет позиций</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Добавьте позиции в раздел, чтобы они появились в меню.
                  </p>
                  <Button className="mt-4">Добавить позицию</Button>
                </div>
              </div>
            )}
          </CardContent>
